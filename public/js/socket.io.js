...
if (loginForm) {
  const logearVerificarUsername = () => {
    const usernameLogin = document.getElementById("usernameLogin").value;
    socket.emit("logearVerificacionUsername", usernameLogin);
  };

  const logearVerificarPassword = () => {
    const passwordLogin = document.getElementById("passwordLogin").value;
    socket.emit("logearVerificacionPassword", passwordLogin);
  };
  ...
  btnLogin.addEventListener("click", async () => {
    logearVerificarUsername();
    logearVerificarPassword();
